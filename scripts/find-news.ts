...
const FEEDS: Feed[] = [
  ...
  // hfea.gov.uk serves no feed: /rss/news/ was a guess and 404s. The regulator
  // is also a GOV.UK organisation, and GOV.UK serves every organisation's
  // announcements as Atom from the org page with `.atom` appended. Confirmed
  // with `--check-feeds` on 2026-09-14: 200, application/atom+xml, 20 entries.
  { outlet: "HFEA", url: "https://www.gov.uk/government/organisations/human-fertilisation-and-embryology-authority.atom", topic: "Safety & regulation", verified: true },
];
