        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              />
              <button className="inline-flex items-center justify-center gap-2 rounded-full bg-accent text-foreground px-7 py-3.5 text-sm font-sans font-medium hover:bg-accent-dark transition-colors duration-200 shrink-0">
                Subscribe
