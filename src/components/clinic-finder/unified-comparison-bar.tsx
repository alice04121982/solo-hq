...
interface UnifiedComparisonBarProps {
  selected: ComparableClinic[];
  onRemove: (id: string) => void;
  onCompare: () => void;
  onClear: () => void;
}

export function UnifiedComparisonBar({
  selected,
  onRemove,
  onCompare,
  onClear,
}: UnifiedComparisonBarProps) {
  return (
    <AnimatePresence>
      {selected.length >= 1 && (
        <motion.div
