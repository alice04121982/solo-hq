...
export const GUIDES: Guide[] = [
  // ─── Finance & Costs ────────────────────────────────────────────────────────
  {
    ...
    readTime: "8 min read",
    intro:
      "The headline IVF price you see on a clinic's website is rarely the number you'll pay. For solo patients using donor sperm, the real cost is typically 30–50% higher than the advertised figure. This guide breaks down every line item so you can build an accurate budget before you begin.",
    sections: [
      {
      ...
      {
        heading: "Real total: what a solo patient pays",
        body: [
