...
export const GUIDES: Guide[] = [
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Optional add-ons (PGT-A, embryo glue, assisted hatching): £500–£3,000",
        ],
      },
      {
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Contact HR or your benefits team directly and ask explicitly, as many employees do not know these benefits exist",
          "Check whether your employer is listed on the Fertifa employer directory at fertifa.com",
          "If your employer has no policy, consider whether you are in a position to advocate for one, as the business case for fertility benefits is well established",
        ],
        callout:
      ...
      },
      {
        ...
        bullets: [
          ...
          "Some clinics run their own hardship or bursary programmes, so always ask",
      ...
      },
      {
        ...
        body: [
          "Fertility treatment costs are not tax-deductible for employees in the UK. However, if you are self-employed and receiving fertility treatment partly to preserve your ability to work, some costs may have a legitimate business case, so discuss this with an accountant.",
    ...
    keyTakeaways: [
      "Check your employer's benefits portal, as fertility funding is more common than most employees realise",
      "NHS funding for single women exists in some areas, so always check your local ICB criteria",
...

  {
    ...
    readTime: "3 min read",
    intro:
      "A complete IVF budget template covering every cost category for solo patients using donor sperm. Use this as your financial planning baseline and adjust the figures to match quotes from your chosen clinic.",
    sections: [
      {
    ...
    keyTakeaways: [
      ...
      "FETs are significantly cheaper than fresh cycles, so track your frozen embryos carefully",
    ],
  },

  {
    ...
    keyTakeaways: [
      "Check what already exists before asking, as many employees are unaware of existing benefits",
  ...
  // ─── Treatment & Clinics ─────────────────────────────────────────────────────
  {
    ...
    sections: [
      {
        ...
        callout:
          "Cost: approximately £800–£1,500 per cycle including donor sperm. For context, three failed IUI cycles costs roughly the same as one IVF cycle, so factor this into your planning.",
      },
      {
        ...
        bullets: [
          "Allows embryo freezing, giving you future FET attempts from a single stimulation",
    ...
    keyTakeaways: [
      "IUI is lowest cost and least invasive but has lower success rates, so it is most suitable under 35 with good ovarian reserve",
...

  {
    ...
    readTime: "5 min read",
    intro:
      "Your first fertility consultation typically lasts 45–60 minutes and covers a lot of ground quickly. Going in with prepared questions ensures you leave with the information you need to make decisions. This checklist covers everything worth asking, so pick the ones most relevant to your situation.",
    sections: [
      {
      ...
      },
      {
        ...
        numbered: [
          ...
          "What is your embryo transfer policy? Is it single embryo transfer only?",
          "What support do you offer if a cycle fails or if I have a pregnancy loss?",
        ],
      },
    ],
    keyTakeaways: [
      "Always ask for a full itemised written quote before you leave, as verbal estimates are not reliable",
      ...
      "Understand the monitoring scan schedule before you commit, as this affects your working life significantly",
...

  {
    ...
    keyTakeaways: [
      ...
      "Raw rate comparison is misleading, as patient mix and transfer policy affect the numbers",
...

  {
    ...
    sections: [
      {
        ...
        callout:
          "The HFEA's position and the research on donor-conceived adults both support openness from an early age. The decision you make about your donor will be part of your child's story, so plan now for how you will share it.",
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          "London Sperm Bank (londonspermbank.com): UK-based. More limited pool but straightforward logistics, with no import required.",
      ...
      },
      {
        ...
        bullets: [
          "Decide early which attributes matter to you and which do not, as this prevents decision paralysis across hundreds of profiles",
          "Physical resemblance to you can make donor conception conversations with your child slightly easier, but is not essential",
          "The personal statement or motivations section is often the most meaningful part of a profile, as it gives you a sense of who this person is",
          ...
          "Buy 3–4 vials upfront if you find a donor you feel good about, as sibling potential and price stability are both reasons to buy in advance",
        ],
        callout:
    ...
    keyTakeaways: [
      "UK law requires identity-release donors, so your child can access identifying information at age 18",
  ...
  // ─── Emotional Wellbeing ─────────────────────────────────────────────────────
  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Moderate physical activity (walking, yoga), as there is no evidence that rest improves outcomes, and movement helps anxiety",
        ...
        postBullets: [
          "Googling symptoms or 'early signs of implantation', as the information is conflicting, unhelpful, and anxiety-amplifying",
          ...
          "Treating this period as 'just waiting', when it is an active emotional experience that deserves real support",
        ],
      },
      {
    ...
    keyTakeaways: [
      "Plan specific activities for each day of the two-week wait, as unstructured time amplifies anxiety",
      "Tell one or two trusted people you are in the wait so you have support available",
      "Avoid early home tests, symptom googling, and forum-checking, as none of it helps",
      "Think through your plan for test day and the 24 hours after, for both a positive and a negative result",
      "Take the day off work for your test, as it is not a normal day regardless of the outcome",
    ],
  },

  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "If you had embryos tested (PGT-A), ask for the full genetic report, as this gives more information about why a transfer may not have worked",
    ...
    keyTakeaways: [
      "Give yourself time to grieve before trying to plan, as there is no clinical urgency to decide quickly",
      "Request a thorough debrief with your consultant after any failed cycle",
      "Continuing treatment should be a genuine choice, not a default, so check in with your actual desires",
...

  {
    ...
    keyTakeaways: [
      "Fertility-specific experience matters, so use BICA (bica.net) to find qualified fertility counsellors",
      "Your HFEA-licensed clinic must offer access to counselling, so ask for it",
      "Online therapy removes geographic barriers, and several platforms offer fertility specialists",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "Allow people time to adjust, as an initial reaction is not always the final one. Some family members who were initially resistant become enthusiastic grandparents",
        ],
      },
      {
    ...
    keyTakeaways: [
      "Choose your audience and timing deliberately, as you are not obliged to tell anyone until you are ready",
      "Come to the conversation confident and matter-of-fact, not defensive",
      "Use the word 'decided', as it signals the decision is made and reduces invitation to debate",
      "Name what support looks like for you, as many people want to help but do not know how",
      "Initial difficult reactions are often not the final position, so give people time to adjust",
    ],
  },
  ...
  // ─── Legal & Admin ───────────────────────────────────────────────────────────
  {
    ...
    sections: [
      {
        ...
        callout:
          "The key protection: treatment at a licensed clinic. If you are using a home insemination kit or a known donor outside of a clinic, get legal advice before proceeding, as the donor may have legal rights.",
      },
      {
      ...
      },
      {
        ...
        body: [
          ...
          "This information is held by the HFEA register and cannot be removed. Your child can request it themselves when they reach adulthood, and it is not conditional on your consent at that point.",
      ...
      },
      {
        ...
        body: [
          "You will register the birth as the sole parent. The birth certificate will show your name only, with no donor entry. This is legally straightforward for solo parents using licensed treatment.",
    ...
    keyTakeaways: [
      ...
      "Home insemination with a known donor creates a different legal picture, so get legal advice first",
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "This operates entirely separately from the HFEA and relies on people choosing to register. It can be a meaningful resource for your child in adulthood, and it is worth being aware of it.",
        ],
      },
    ],
    keyTakeaways: [
      "The HFEA register holds the donor's identifying information, and your child can access it at 18",
      "Access requires an application and is not automatic",
      "DNA ancestry tests mean donor-conceived people are increasingly finding out through other means, and early disclosure removes the risk of an uncontrolled discovery",
...

  {
    ...
    keyTakeaways: [
      "Using a known donor through a licensed clinic gives you full legal protection, which home insemination does not",
      ...
      "Have explicit conversations about the donor's intended role before you start, and document your alignment",
    ],
  },
    ...
    sections: [
      {
        ...
        body: [
          "Self-employed women in the UK can claim Maternity Allowance (MA) rather than Statutory Maternity Pay (SMP), as SMP is only available through employed positions. MA is paid by the government and is separate from your employer.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "If you have business expenses ongoing during maternity leave (software subscriptions, insurance, etc.), keep records, as these remain deductible",
          "Class 2 NI contributions continue to accrue during maternity leave if you remain registered as self-employed",
          "Consider whether to pause your sole trader registration if you are planning a longer break, as this affects your NI record and benefit entitlements",
      ...
      },
      {
        ...
        body: [
          "The government's free childcare offer (15–30 hours per week from 9 months of age in England as of 2024) is available to self-employed parents. Your eligibility is based on earning the equivalent of minimum wage for 16 hours per week on average, which is very achievable for most self-employed people even during part-time return.",
          "Apply via the government's childcare service (childcarechoices.gov.uk) as soon as you are eligible. Places in nurseries and childminder settings are often limited, so research local provision before your child is born.",
        ],
      },
    ],
    keyTakeaways: [
      ...
      "Plan to supplement MA with savings, as it covers a fraction of typical self-employed income",
      "Free childcare from 9 months is available to self-employed parents, so apply early as places are limited",
    ],
  },
  ...
  // ─── Pregnancy & Beyond ──────────────────────────────────────────────────────
  {
    ...
    keyTakeaways: [
      "Deliberately build your village in advance, and do not assume people will show up",
      "Be specific when asking for help, as general offers rarely materialise into practical support",
      "Use a shared calendar or rota for postnatal support",
      "A doula is especially valuable for solo births and postnatal recovery",
      "Connect with the SMC community, as no one understands the specific experience better",
    ],
  },

  {
    ...
    keyTakeaways: [
      "A birth partner's role is support, not medical decision-making, so choose someone calm and reliable",
      "Two birth partners is an option, as many hospital policies allow this",
      "A doula brings professional experience and continuity that friends and family cannot offer",
      "Preparation is essential, so attend antenatal classes together and discuss your preferences explicitly",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "At this stage, the story needs to be simple, positive, and woven into normal family conversation. You do not need a specific 'disclosure conversation', as it should just be part of how you talk about your family.",
      ...
      },
      {
        ...
        bullets: [
          "The donor is not their 'dad', as he was not involved in their life and does not live with anyone as their dad",
          ...
          "Their family is complete exactly as it is, and different does not mean less",
        ],
      },
      {
        heading: "Teenage years and adulthood",
        body: [
          "Teenagers often revisit their conception story with more complexity, as questions of identity, belonging, and difference emerge more forcefully. This is normal and does not indicate that disclosure was done incorrectly.",
          ...
          "At 18, they can access the HFEA register for identifying information about their donor. This is their right and their choice, so prepare for this possibility and support whatever decision they make.",
        ],
      },
    ],
    keyTakeaways: [
      ...
      "DNA tests mean your child may find out another way, and being the one to tell them protects their trust in you",
      "Donor Conception Network (dcnetwork.org) has excellent books and resources for every age",
      "Their right to access HFEA register information at 18 is theirs alone, so support whatever they choose",
    ],
  },
    ...
    sections: [
      {
        ...
        body: [
          ...
          "Register interest at multiple settings, as you can always decline a place, but you cannot add to a list that has closed.",
        ],
      },
      {
      ...
      },
      {
        ...
        bullets: [
          ...
          "Nanny (sole): sole nanny is the most expensive but offers the most flexibility for solo parents, with no nursery drop-off logistics",
      ...
      },
      {
        ...
        bullets: [
          ...
          "Build a relationship with your nursery key worker, as they are your eyes and ears and genuine allies",
          "Consider a childminder over a nursery if flexibility is your priority, as childminders often have more latitude with drop-off and collection times",
          "Emergency childcare services (some employers offer these through EAP or benefits platforms) can cover acute gaps",
        ],
      },
    ],
    keyTakeaways: [
      "Register nursery interest from around 20 weeks pregnant, as good places have 12–18 month waiting lists",
      ...
      "Have two to three people identified for emergency childcare, as solo parents need an explicit backup plan",
      "A childminder often offers more flexibility than a nursery setting, so consider this if your schedule is unpredictable",
    ],
  },
...

  {
    ...
    keyTakeaways: [
      ...
      "Memoirs are especially valuable during treatment, as they remind you that others have been in exactly this place",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Search #soloparenting, #solomotherbyChoice, #singlemombyChoice on Instagram to find a significant community of people sharing their journeys openly",
    ...
    keyTakeaways: [
      "Facebook groups are the primary hub for the UK SMC community, so join two or three at different stages",
      ...
      "Use communities for emotional support and shared experience, and verify clinical information with your medical team",
...

  {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "Your HFEA-licensed clinic is legally required to offer access to counselling at all stages of treatment. Ask your clinic coordinator about this, as it is often underused.",
      ...
      },
      {
        ...
        body: [
          ...
          "Some fertility clinics run their own patient support groups or peer matching schemes, so ask your clinic whether they have anything like this. Bourn Hall and CARE Fertility both run community events.",
        ],
        callout:
    ...
    keyTakeaways: [
      ...
      "Donor Conception Network (dcnetwork.org) is essential for anyone using donor conception, with workshops and resources for all stages",
      "Your HFEA-licensed clinic must offer counselling access, so ask for it",
      "Gingerbread (gingerbread.org.uk) covers the practical landscape of single parenting comprehensively",
      "Local groups often exist and are worth seeking out, as the in-person community makes a difference",
    ],
  },
];
