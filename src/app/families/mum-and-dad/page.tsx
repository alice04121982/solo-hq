...
export const metadata: Metadata = {
  title: "Mum & Dad families | KLEO Fertility",
  description:
    "Egg donation, sperm donation, double donation, embryo donation — honest guidance for couples building their family with a little extra help.",
};
      ...
      <section className="bg-bg-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20 md:py-28">
          ...
          <p
            ...
            style={{ maxWidth: "52ch" }}
          >
            Egg donation, sperm donation, double donation, embryo donation —
            honest guidance for couples building their family with a little
            extra help.
          </p>
      ...
      <section className="bg-bg-primary border-y border-border-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20">
          ...
          <p
            ...
            style={{ maxWidth: "48ch" }}
          >
            We&apos;re building out dedicated content for Mum &amp; Dad
            families. Sign up to be notified when it&apos;s ready.
          </p>
        </div>
      </section>
