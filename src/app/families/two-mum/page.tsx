...
export const metadata: Metadata = {
  ...
  description:
    "Whether you're exploring reciprocal IVF, sperm donation, or co-parenting — guidance for same-sex female couples at every stage.",
};
      ...
      <section className="bg-bg-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20 md:py-28">
          ...
          >
            ...
            co-parenting — guidance for same-sex female couples at every stage.
          </p>
      ...
      <section className="bg-bg-primary border-y border-border-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20">
          ...
          <p
            ...
            style={{ maxWidth: "48ch" }}
          >
            We&apos;re building out dedicated content for two mum families.
