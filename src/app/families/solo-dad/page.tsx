...
export const metadata: Metadata = {
  ...
  description:
    "Single men building their family through surrogacy, adoption, or donor conception. Practical guidance for every step.",
};
      ...
      <section className="bg-bg-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20 md:py-28">
          ...
          <p
            ...
            style={{ maxWidth: "52ch" }}
          >
            Single men building their family through surrogacy, adoption, or
            donor conception. Practical guidance for every step.
          </p>
      ...
      <section className="bg-bg-primary border-y border-border-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20">
          ...
          <p
            ...
            style={{ maxWidth: "48ch" }}
          >
            We&apos;re building out dedicated content for solo dad families.
