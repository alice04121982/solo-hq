...
export const metadata: Metadata = {
  ...
  description:
    "Navigating surrogacy, adoption, and donor conception as a same-sex male couple. Everything you need to know.",
};
      ...
      <section className="bg-bg-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20 md:py-28">
          ...
          <p
            ...
            style={{ maxWidth: "52ch" }}
          >
            Navigating surrogacy, adoption, and donor conception as a same-sex
            male couple. Everything you need to know.
          </p>
      ...
      <section className="bg-bg-primary border-y border-border-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20">
          ...
          <p
            ...
            style={{ maxWidth: "48ch" }}
          >
            We&apos;re building out dedicated content for two dad families.
