    ...
    <main className="min-h-screen bg-background">
      ...
      <Section band={0} padding="pt-20 pb-16 md:pt-28 md:pb-20">
        <SectionHeading
          ...
          title="Worth reading."
          intro="Reporting on fertility treatment from people who do it for a living, with a note on what each piece changes for someone choosing a clinic. We do not write the news, and we do not reprint it: every link here goes to the publisher who did the work."
          introWidth="56ch"
          className="mb-8"
        />
      ...
      <Section band={2}>
        <h2
          className="font-sans font-bold text-teal mb-8"
      ...
      <Section band={3} padding="py-16 md:py-20">
        <div className="rounded-[24px] border border-border bg-background p-6 md:p-8" style={{ maxWidth: "72ch" }}>
          <h2 className="font-sans font-semibold text-teal text-lg mb-3">
