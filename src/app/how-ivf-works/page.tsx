        ...
        <div className="flex flex-wrap gap-2">
          {STAGES.map((s) => (
            <a
              key={s.number}
              href={`#step-${s.number}`}
              className="group inline-flex items-center gap-1.5 rounded-full bg-background px-3.5 py-1.5 text-xs font-sans text-teal hover:bg-teal hover:text-on-teal transition-colors"
            >
