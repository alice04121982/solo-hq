...
export const metadata: Metadata = {
  title: "FAQs | KLEO Fertility",
  description:
    "Quick answers to the most common questions about KLEO Fertility, our data, and how we work.",
};
      ...
      <section className="bg-bg-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20 md:py-28">
          ...
          <p
            ...
            style={{ maxWidth: "52ch" }}
          >
            Quick answers to the most common questions about KLEO Fertility,
            our data, and how we work.
          </p>
      ...
      <section className="bg-bg-primary border-y border-border-secondary">
        <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-20 py-20">
          ...
          <p
            ...
            style={{ maxWidth: "48ch" }}
          >
            We&apos;re building out FAQ content. Sign up to be notified when
            it&apos;s ready.
          </p>
        </div>
      </section>
